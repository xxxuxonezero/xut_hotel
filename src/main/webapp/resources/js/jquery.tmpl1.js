...
/*
    ...
    http://borismoore.github.io/jquery-tmpl/demos/step-by-step/1_tmpl-interactive/1_tree-view-using-tmpl-tag-source.html
    {%tmpl <template>%}
    {%= js call %}
    {%html js call %}
*/
(function($, undefined) {
        ...
        tmpl: function(tmpl, data, options, parentItem) {
            ...
            ret = $.isArray(data) ?
                    $.map(data, function(dataItem, index) {
                        if (dataItem) {
                            dataItem.$index = index + 1 >= 10 ? index + 1 :  '0' + (index + 1);
                        }
    ...
    function buildTmplFn(markup) {
        ...
        var depreciated_parse = function() {
            if($.tmpl.tag[arguments[2]] &&  window.console &&  console.info) {
