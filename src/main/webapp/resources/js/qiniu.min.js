    ...
    this.uploader = function (b) {
        ...
        return k.bind("Init", function () {
            ...
            var e = function (c, d, e) {
                ...
                c.setOption({url: "http://up-z2.qiniup.com/", multipart: !0, chunk_size: void 0, multipart_params: f})
            ...
            if (h = h || c.settings && c.settings.chunk_size, "html5" === k.runtime && h) if (d.size < h) e(c, d, a.key_handler); else {
                ...
                g.startTime = (new Date).getTime(), c.setOption({
                    url: "http://up-z2.qiniup.com/mkblk/" + l,
                    multipart: !1,
                    chunk_size: h,
                    required_features: "chunks",
                    headers: {Authorization: "UpToken " + a.token, Access-Control-Allow-Origin: "*"},
                    multipart_params: {}
                })
            ...
            h = h || b.settings && b.settings.chunk_size, h > g && b.setOption({url: "http://up-z2.qiniup.com/mkblk/" + g}), localStorage.setItem(c.name, JSON.stringify({
                ctx: f,
                percent: c.percent,
                total: d.total,
                offset: d.offset,
            ...
            return function (d, e, g) {
                ...
                if (f = f ? f : i.ctx) {
                    ...
                    var q = "http://up-z2.qiniup.com/mkfile/" + e.size + l + o, r = a.createAjax();
        ...
        var c = a["auto-orient"] || "", d = a.thumbnail || "", e = a.strip || "", f = a.gravity || "", g = a.crop || "",
            h = a.quality || "", i = a.rotate || "", j = a.format || "", k = a.blur || "", l = "imageMogr2";
        ...
        if (1 === c) {
            ...
            if (2 !== c) return !1;
            var f = a.text ? a.text : "", g = a.font ? a.font : "", h = a.fontsize ? a.fontsize : "",
                i = a.fill ? a.fill : "";
            if (!f) return !1;
